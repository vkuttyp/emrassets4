<template>
    <div class="relative">
      ...
      >
        ...
        <span class="m-2">{{ $i18n.locale.toUpperCase() }}</span>
      ...
      <transition name="dropdown-fade">
        <ul v-click-away="hideDropdown" v-if="isVisible" ref="dropdown" class="absolute normal-case z-30 font-normal xs:left-0 lg:right-0 bg-white shadow overflow-hidden rounded w-48 border mt-2 py-1 lg:z-20">
          <li>
            <a
              href="#"
              ...
              @keydown.esc.exact="hideDropdown"
            >
              <img src="/flag_ar.svg" alt="Saudi flag" class="h-8 w-8">
              <span class="ml-2">{{$t("common.ar")}}</span>
            </a>
          </li>
          <!-- <li>
            <a
          ...
          <li>
            ...
            >
              ...
              <span class="ml-2">{{$t("common.en")}}</span>
            </a>
          </li>
        </ul>
      </transition>
